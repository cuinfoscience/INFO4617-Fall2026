    ...
    \begin{columns}[T]
        \begin{column}{0.6\textwidth}
            ...
            \begin{enumerate}\small
                \item Get one Census variable group for 5 or more geographies. Make a visualization that compares them.
                \item Plot two related FRED series for your area on the same axes. Explain what they show.
                \item Get the FEC contributions for a local congressional race.
                \item Combine data from two government APIs in one analysis.
                \item Get one Census variable for all Colorado counties with \texttt{county:*}. Make a bar chart of the 20 highest values.
                \item[6.] \textbf{5617}: read \textcite{lazer2020computational}. Link two APIs. Write a limitations section about measurement and coverage.
            \end{enumerate}
        \end{column}
        \begin{column}{0.35\textwidth}
            \begin{block}{Show-and-Tell}
                ...
                \begin{itemize}\footnotesize
                    ...
                    \item a number that surprised you
