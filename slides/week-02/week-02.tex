...
\begin{frame}{Activity: survey a sector}
    \begin{columns}[T]
        \begin{column}{0.6\textwidth}
            Three sites tell you little. A \textbf{sector} tells you about a business model. Select one row. Get the \texttt{robots.txt} file of each site in that row. Compare them:
            \begin{itemize}\small
