...
\begin{frame}[fragile]{Then: launch Jupyter and open the notebook}
    \begin{columns}[T]
        \begin{column}{0.6\textwidth}
            ...
            print(os.getcwd())
            \end{lstlisting}
            should print the folder you launched Jupyter from -- if it doesn't, stop the server (Ctrl+C), cd to the right folder, and relaunch

            \medskip
            
            This three-command sequence --- \texttt{cd}, activate, launch --- is worth memorizing now. Every notebook lab this semester starts the same way.
        \end{column}
        \begin{column}{0.35\textwidth}
