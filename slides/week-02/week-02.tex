...
\begin{frame}{Aaron Swartz and Cambridge Analytica}
    \begin{columns}[T]
        \begin{column}{0.6\textwidth}
            \textbf{Aaron Swartz (2011--2013).} Swartz used MIT's network to bulk-download academic articles from JSTOR. Federal prosecutors charged him under the CFAA with eleven counts. Together they carried decades of theoretical exposure. The prosecutors argued that a violation of a terms-of-use agreement was ``unauthorized access.'' He died by suicide in 2013, at 26.
        ...
        \begin{column}{0.35\textwidth}
            \begin{block}{Consequences}
                \footnotesize After \textbf{Swartz}, researchers knew that a vague statute could be aimed at them.

                \smallskip

                After \textbf{Cambridge Analytica}, platforms treated open access as a liability.

                \smallskip

                Access was already closing before AI arrived (Ch.~3).
            \end{block}
        \end{column}
    \end{columns}
