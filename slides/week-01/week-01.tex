...
\begin{frame}{The book: built and published}
...
\begin{frame}{Git \& GitHub}
    \begin{columns}[T]
        \begin{column}{0.6\textwidth}
            ...
            \medskip
            Git is \textbf{version control} software. It records the history of a project: who changed what, when, and why. It also lets many people work on the project at the same time. Their changes do not overwrite each other.
...
\begin{frame}{Grading issues and pull requests}
    \begin{columns}[T]
        \begin{column}{0.6\textwidth}
