...
\begin{frame}{Data in the public interest}
    \begin{columns}[T]
        ...
        \begin{column}{0.38\textwidth}
            ...
            \begin{center}
                \includegraphics[width=.5\textwidth]{slides/common/cupids-logo.png}
            \end{center}
...
\begin{frame}{Common sequence across topics}
    \begin{columns}[T]
        ...
        \begin{column}{0.42\textwidth}
            \centering
            \includegraphics[width=\textwidth]{slides/week-01/img/pageviews.pdf}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{How this book was written}
    \begin{columns}[T]
        \begin{column}{0.6\textwidth}
            ...
            \medskip
            This will not be your last time polishing ``AI slop'' so it is worth understanding its tells, limits, and how to collaborate on a team to improve it
