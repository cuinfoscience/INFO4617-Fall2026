...
\begin{frame}[fragile]{Strategy 6 --- cards to rows: the Oscars parser}
    oscars.org 403s an anonymous or browser-spoofed request --- but not this honestly-identified one. Then navigate down through the real container hierarchy, category by honoree:
\begin{lstlisting}
url = "https://www.oscars.org/oscars/ceremonies/2026"
soup = BeautifulSoup(requests.get(url, headers=headers).text, "html.parser")
