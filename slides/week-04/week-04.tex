...
\begin{frame}{Daily note questions}
    \begin{itemize}\small 
        ...
        \item \textbf{Concerns with citing information added to textbook?} --- Pull requests merge after we review them together at a Friday code-review standup; a merged change updates the textbook for everyone.
    ...
    \begin{columns}[T]
        \begin{column}{0.6\textwidth}
            ...
            \begin{enumerate}\small
                \item \textbf{RSS feed} --- parse a news feed with the \texttt{"xml"} parser. Extract the title, the link, and the date. Put them in a DataFrame. \footnotesize Starter feeds and how to find your own: this week's handout.
