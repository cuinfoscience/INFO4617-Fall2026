    ...
    \begin{columns}[T]
        \begin{column}{0.6\textwidth}
            ...
            \begin{itemize}\small
                ...
                \item Close with a live pair activity: time travel with the Wayback Machine
            \end{itemize}
...
\begin{frame}{Link rot}
    \begin{columns}[T]
        \begin{column}{0.6\textwidth}
            ...
            \bigskip
            {\footnotesize Pew Research Center, ``When Online Content Disappears'' (2024)}
        ...
        \begin{column}{0.35\textwidth}
            \centering
            \includegraphics[width=\textwidth]{img/meme_link_rot.png}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Finding a capture}
    \begin{center}
        \includegraphics[width=.78\textwidth]{img/wayback_calendar.png}
    \end{center}
...
\begin{frame}{About this capture}
    \begin{center}
        \includegraphics[width=\textwidth]{img/about_capture.png}
    \end{center}
    ...
    \bigskip
    The logo on this February 12, 2004 capture of Thefacebook was saved \textbf{three months and twenty days later}.
...
\begin{frame}{Reading the dots}
    \begin{columns}[T]
        \begin{column}{0.6\textwidth}
            ...
            \bigskip
            facebook.com in 2005: blue through March, then a run of orange 403s, then blue again from August 6 --- now serving Thefacebook's homepage. The domain had changed hands.
...
\begin{frame}{Broken captures}
    \begin{columns}[T]
        \begin{column}{0.6\textwidth}
            ...
            \bigskip
            The HTML was saved on November 14, 1999. Most of its images were not.

            \bigskip
            Replay borrows each image from its nearest capture in time. Some of these were only saved months later, and some only as 404s after the site had changed.
...
\begin{frame}{Missing captures}
    \begin{columns}[T]
        \begin{column}{0.6\textwidth}
            ...
            \bigskip
            \textbf{Exclusions.} Site owners can ask the Archive to hide their pages.
        ...
        \begin{column}{0.35\textwidth}
            \centering
            \includegraphics[width=\textwidth]{img/meme_archives_incomplete.png}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Why some sites are archived better}
    ...
    google.com: almost 20 million captures. facebook.com: 8.4 million. x.com: 83,190. (September 2026)
...
\begin{frame}{google.com, November 1998}
    ...
    \bigskip
    Almost twenty million captures later (September 2026).
\end{frame}
...
\begin{frame}{Internet Jones and the Raiders of the Lost Trackers}
    \begin{columns}[T]
        \begin{column}{0.6\textwidth}
        ...
        \begin{column}{0.35\textwidth}
            \centering
            \includegraphics[width=\textwidth]{img/meme_internet_jones.png}
        \end{column}
    \end{columns}
    \begin{alertblock}{Consequences}
        The archive's gaps are not a footnote. They belong in your methods section.
    \end{alertblock}
\end{frame}
...
\begin{frame}{Closing activity: time travel with the Wayback Machine}
    \begin{columns}[T]
        ...
        \begin{column}{0.35\textwidth}
            \centering
            \includegraphics[width=\textwidth]{img/meme_i_was_there.png}
        \end{column}
    \end{columns}
\end{frame}
