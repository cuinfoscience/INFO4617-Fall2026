...
\begin{frame}{The web is not permanent}
    \begin{columns}[T]
        \begin{column}{0.6\textwidth}
            ...
            This is a research problem. How do you study something that can disappear tomorrow? How do you measure a \textit{change} when you can see only today's version?
