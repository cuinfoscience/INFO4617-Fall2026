...
\newcommand{\cupids}[1][1]{\scalerel*{\includegraphics{../common/cupids-logo.pdf}}{X}\scalebox{#1}{}}
...
\setlength{\smallskipamount}{2.5pt plus 1pt minus 1pt}
\setlength{\medskipamount}{5pt plus 1.5pt minus 1.5pt}
...
\newcommand{\bottomcite}[1]{%
  \begin{tikzpicture}[remember picture, overlay]
    \node[anchor=south west, align=flush left,
      ...
      {\tiny\rule{\linewidth}{0.3pt}\\[-1.8ex]#1};
  \end{tikzpicture}%
}
