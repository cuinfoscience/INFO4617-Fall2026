...
Because the Wednesday labs and Friday revision workshops are collaborative and graded on in-class participation, regular attendance is essential. If personal, professional, medical, or other circumstances will prevent your attendance, please notify the instructor via e-mail so we can develop an accommodation plan together.
...
Accessing and parsing PDFs with \href{https://pypdf.readthedocs.io/}{\texttt{pypdf}}. Textbook: \bookch{ch-09-pdfs}{Chapter 9 (Extracting Data from PDFs)}.
