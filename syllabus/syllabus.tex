...
% PLACEHOLDER: confirm office hours before publishing
\def\instructorofficehours{\textit{[TBD --- posted on Canvas]}}
...
\centering
    \begin{tabular}{cccc}
        ...
        \multirow{4}{*}[0pt]{\textit{Documents}}
            ...
            & 7 & Sep.~28--Oct.~2 & Archived web pages \& the Wayback Machine \\
        ...
        \multirow{4}{*}[0pt]{\textit{APIs}}
            & 10 & Oct.~19--23 & Wikipedia APIs \quad \small(\textit{proposal due Oct.~23}) \\
        ...
        \bottomrule[.15em]
    \end{tabular}
    \caption{Course outline by week. Labor Day (Sep.~7) and Fall Break (Nov.~23--27) have no class; the last day of class (Dec.~4) follows a Monday schedule.}
